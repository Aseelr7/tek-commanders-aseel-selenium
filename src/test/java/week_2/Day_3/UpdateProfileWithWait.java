...
public class UpdateProfileWithWait {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("input#personalPhoneInput")))
                .clear();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("input#personalPhoneInput")))
                .sendKeys("5113288897");
        ...
        WebElement toastify = wait.until(ExpectedConditions.visibilityOfElementLocated(
